...
To build the final jar and optimize the finavaidentity application for production, run:
...
You can use Docker to improve your JHipster development experience. A number of docker-compose configuration are available in the [src/main/docker](src/main/docker) folder to launch required third party com.breathebinary.finava.services.

You can also fully dockerize your application and all the com.breathebinary.finava.services that it depends on.

...
import com.breathebinary.finava.config.ApplicationProperties
...
class FinavaidentityApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes finavaidentity.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<FinavaidentityApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(FinavaidentityApp::class.java)

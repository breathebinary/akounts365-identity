package com.breathebinary.finava.aop.logging
...
open class LoggingAspect(private val env: Environment) {
    ...
    /**
     * Pointcut that matches all repositories, com.breathebinary.finava.services and Web REST endpoints.
     */
    @Pointcut(
     ...
     */
    @Pointcut(
        "within(com.breathebinary.finava.repository..*)" +
            " || within(com.breathebinary.finava.service..*)" +
            " || within(com.breathebinary.finava.web.rest..*)"
    )
